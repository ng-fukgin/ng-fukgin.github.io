...
```yml
# Site settings
title: Wufujian Blog             # title of your website
SEOTitle: Wufujian Blog          # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: ng-fukgin     # modify this account to yours
weibo_username: 肆岁小朋友      # the footer woule be auto-updated.
